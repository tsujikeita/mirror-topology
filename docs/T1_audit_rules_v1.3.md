# T1_audit_rules v1.3（凍結・2026-08-27）

T1遡及監査版（MirrorTopology_T1_signmap v1.3_audited）のofficial実行を拘束する凍結規則。
...
エンジン層：G07 M unitarity<1e-12／G08 roundtrip<1e-9／G09 reality／G10 二点相関等価<1e-10／
